...
> and the [runtime boundary](../docs/permanent-risu-host-backend-boundary.md), checked against active source.
...
> API schema inputs: `contracts/openapi-schema-freeze.json`, `contracts/openapi-contract-summary.json`.
> Date: 2026-05-21
